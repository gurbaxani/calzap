		...
		>
			...
			<div class="flex items-center gap-3">
				<a
					...
					class="hidden sm:inline-flex items-center gap-2 px-4 py-2.5 rounded-xl border border-(--border) hover:bg-zinc-100/50 dark:hover:bg-zinc-800/30 text-zinc-500 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-200 font-bold transition-all text-xs active:scale-[0.98] select-none cursor-pointer"
				>
